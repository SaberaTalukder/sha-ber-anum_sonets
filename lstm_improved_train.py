...
def get_training():
    ...
    chunks = [sonnet[i:i+context_length] for sonnet in temp  for i in range(len(sonnet)-context_length)]
...
checkpoint_dir = './training_checkpoints_improved'
...
def train_model():
    ...
    model.fit(dataset, epochs=10, verbose=2, callbacks=[checkpoint_callback])
    return model
...
start_string = u"shall i compare thee to a summer's day?\n"
#start_string = u"testing testing, one two three.\n"

print(generate_text(model, start_string=start_string))
print('')
print('temperature: 0.05')
print(generate_text(model, start_string=start_string,temperature=0.05))
print('')
print('temperature: 0.25')
print(generate_text(model, start_string=start_string,temperature=0.25))
print('')
print('temperature: 0.75')
print(generate_text(model, start_string=start_string,temperature=0.75))
print('')
print('temperature: 1.5')
print(generate_text(model, start_string=start_string,temperature=1.5))
